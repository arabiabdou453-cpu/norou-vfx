...
$checks = [ordered]@{
    ...
    'Desktop navigation uses a short single-frame animation' = $html -match 'const animateDesktopScrollTo' -and $html -match 'requestAnimationFrame\(step\)' -and $html -match 'duration = 320'
